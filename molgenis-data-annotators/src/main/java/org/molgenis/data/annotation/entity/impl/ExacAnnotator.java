...
public class ExacAnnotator
{
	...
	public RepositoryAnnotator exac()
	{
		...
		DefaultAttributeMetaData exac_gmaf = new DefaultAttributeMetaData(EXAC_GMAF, FieldTypeEnum.DECIMAL)
				.setDescription("Global minor allele frequency derived straight from the ExAC GMAF field").setLabel(
						EXAC_GMAF_LABEL);

		DefaultAttributeMetaData exac_aa_maf = new DefaultAttributeMetaData(EXAC_AA_MAF, FieldTypeEnum.DECIMAL)
				.setDescription(
						"African/African latino minor allele frequency derived straight from the ExAC AMR_MAF field")
				.setLabel(EXAC_AA_MAF_LABEL);

		DefaultAttributeMetaData exac_amr_maf = new DefaultAttributeMetaData(EXAC_AMR_MAF, FieldTypeEnum.DECIMAL)
				.setDescription("American latino minor allele frequency derived straight from the ExAC AMR_MAF field")
				.setLabel(EXAC_AMR_MAF_LABEL);

		DefaultAttributeMetaData exac_afr_maf = new DefaultAttributeMetaData(EXAC_AFR_MAF, FieldTypeEnum.DECIMAL)
				.setDescription("African minor allele frequency derived straight from the ExAC AFR_MAF field")
				.setLabel(EXAC_AFR_MAF_LABEL);

		DefaultAttributeMetaData exac_asn_maf = new DefaultAttributeMetaData(EXAC_ASN_MAF, FieldTypeEnum.DECIMAL)
				.setDescription("Asia minor allele frequency derived straight from the ExAC ASN_MAF field").setLabel(
						EXAC_ASN_MAF_LABEL);

		DefaultAttributeMetaData exac_eur_maf = new DefaultAttributeMetaData(EXAC_EUR_MAF, FieldTypeEnum.DECIMAL)
				.setDescription("European minor allele frequency derived straight from the ExAC EUR_MAF field")
				.setLabel(EXAC_EUR_MAF_LABEL);
